                ...
                >
                  ...
                  <div className="blog-content">
                    <div className="blog-meta">
                      <span>
                        <i className="bi bi-eye"></i> Viwe {item.total_comment}
                      </span>
                      <span>
                        <i className="bi bi-wechat"></i> {item.comment}
                      </span>
                    </div>
                    ...
                    <div className="blog-bottom-shape">
                      <img
                        src="assets/images/resource/blog-shape.png"
                        alt="image-title"
                      />
                    </div>
                    ...
                    <div className="blog-btn">
                      <Link href="/blog">
                        More Details <i className="bi bi-arrow-up-right"></i>
                      </Link>
                    </div>
                  </div>
                </div>
